            ...
            <FrontContent>
                ...
                <div className="flex mb-5 gap-10">
                    <div className="w-3/5 content">
                        ...
                        <ul>
                            <li><b className="text-current">Revisiting one of SilentMode's earliest
                                Creations:</b> CATAWOL Records began life as a modular building.
                            </li>
                            <li><b className="text-current">Embarking on an ambitious [loosely-related] LEGO
                                project:</b> SilentMode's first one to fully incorporate music, as well as
                                computer-generated content.
                            </li>
                            <li><b className="text-current">Creating the <i>first ever anti-bullying campaign</i> (that
                                we know of) within the LEGO space.</b></li>
                            <li><b className="text-current">A live demonstration of coding ability:</b> built
                                single-handedly from scratch, proving that SilentMode <i>can</i> code.
                            </li>
                        </ul>
                    </div>
