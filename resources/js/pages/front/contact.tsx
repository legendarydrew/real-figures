        ...
        <>
            <Head title="Contact">
                <meta name="description"
                      content="Got questions or feedback? Use our contact form to reach the team behind the CATAWOL Records Song Contest. We’d love to hear from you."/>
            </Head>

            <FrontContent>

                <figure className="mb-5">
                    <img className="object-cover h-50 mx-auto" src="/img/fanmail.png"
                ...
                <div className="flex flex-col lg:flex-row gap-5">
                    ...
                    <div className="lg:w-2/5 content">
                        ...
                        <p>Whether you're an artist, a voter, a supporter, or just curious &ndash; we’re all
                            ears.</p>
                        ...
                        {success ? (
                            ...
                            <form onSubmit={submitHandler} className="flex flex-col gap-3">
                                ...
                                <div className="flex flex-col gap-3 lg:flex-row justify-between lg:items-center">
                                    <p className="text-sm text-center lg:text-left">Your details will not be shared
                                        with
                                        anyone.</p>
