...
final class VoteChoicesTest extends TestCase
{
    use DatabaseMigrations;

    protected const string ENDPOINT = 'api/analytics/votes/choices';
    ...
    public function test_with_data(): void
    {
        \Analytics::fake(collect([
            [
                'date' => now()->subDay(),
                'customEvent:choices' => 3,
                'eventCount' => fake()->numberBetween(1, 200),
            ],
            [
                'date' => now()->subDay(),
                'customEvent:choices' => 1,
                'eventCount' => fake()->numberBetween(1, 200),
            ],
            [
                'date' => now()->subDays(2),
                'customEvent:choices' => 2,
                'eventCount' => fake()->numberBetween(1, 200),
            ],
            [
                'date' => now()->subDay(),
