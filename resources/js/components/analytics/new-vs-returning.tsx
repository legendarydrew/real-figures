...
export const NewVsReturningAnalytics: React.FC<Props> = ({ days = 7 }) => {
    ...
    const fetchData = () => {
        ...
        setIsLoading(true);
        axios.get("/api/analytics/user-types", { params: { days } })
            .then((res) => {
    ...
    return (
        <section id="analyticsNewVsReturning" className="analytics-section">
            <h2 className="analytics-section-title">New vs. Returning Visitors</h2>
