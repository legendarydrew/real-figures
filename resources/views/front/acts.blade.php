...
@section('content')
    ...
    <div class="site-container">
        ...
        <p>
            Meet the 32 Acts that were shortlisted for CATAWOL Records' <b>Real Figures Don't F.O.L.D</b> Song Contest.
            Your votes determine which Acts go through to the Final, and which Song will be chosen as the
