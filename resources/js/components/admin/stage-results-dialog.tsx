                        ...
                        <>
                            ...
                            <ul className="mb-5 text-base">
                                {winningRows().map((winner) => (
                                    <li key={winner.id}
                                        className="flex py-1 px-2 justify-between items-center gap-2 my-0.5 h-[4rem] hover:bg-gray-100">
                        ...
                        <>
                            ...
                            <ul className="mb-3 text-sm">
                                {runnerUpRows().map((winner) => (
                                    <li key={winner.id}
                                        className="flex p-1 justify-between items-center gap-2 my-0.5 hover:bg-gray-100">
                                        <ActImage act={winner.song.act}/>
