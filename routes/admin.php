...
use App\Http\Controllers\Back\StageManualVoteController;
...
Route::prefix('/admin')
     ...
     ->group(function ()
     {
         ...
         Route::get('acts', [ActsController::class, 'index'])->name('admin.acts');
         Route::get('acts/new', [ActsController::class, 'create'])->name('admin.acts.new');
         Route::get('acts/{id}', [ActsController::class, 'edit'])->name('admin.acts.edit');
         ...
         Route::get('news/new', [NewsController::class, 'create'])->name('admin.news.create');
         Route::get('news/{id}', [NewsController::class, 'edit'])->name('admin.news.edit');
         Route::get('songs', [SongsController::class, 'index'])->name('admin.songs');
         Route::get('stages', [StagesController::class, 'index'])->name('admin.stages');
         Route::get('stages/{id}/manual-vote', [StageManualVoteController::class, 'show'])->name('admin.manual-vote.show');
         Route::post('stages/{id}/manual-vote', [StageManualVoteController::class, 'store'])->name('admin.manual-vote.store');
         Route::get('subscribers', [SubscribersController::class, 'index'])->name('admin.subscribers');
         Route::get('subscribers-post', [SubscribersPostController::class, 'index'])->name('admin.subscribers-post');
     });
